...
spine-↑∧⁺ {L1 = []} {L2} {L+ = L+} pf S InA InB (↑L-cons pf₁ N) 
  with spine-↑∧⁺-+ {L1 = L+} {L2 = []} pf S InA InB N
... | R rewrite concat-nil L+ = R 
-- Stupid pattern match for Agda
spine-↑∧⁺ {L1 = ._ ∷ []} pf S InA InB (↑L-cons pf₁ N) = 
  ↑L-cons pf₁ (spine-↑∧⁺ {L1 = []} pf S InA InB N) 
spine-↑∧⁺ {L1 = ._ ∷ []} pf S InA InB (⊃L {A₁} {B₁} V Sp) = 
  ⊃L V (spine-↑∧⁺ {L1 = B₁ ∷ []} pf S InA InB Sp) 
spine-↑∧⁺ {L1 = ._ ∷ []} pf S InA InB (∧⁻L₁{A₁} {B₁} Sp) = 
  ∧⁻L₁ (spine-↑∧⁺ {L1 = A₁ ∷ []} pf S InA InB Sp) 
spine-↑∧⁺ {L1 = ._ ∷ []} pf S InA InB (∧⁻L₂ {A₁} {B₁} Sp) = 
  ∧⁻L₂ (spine-↑∧⁺ {L1 = B₁ ∷ []} pf S InA InB Sp) 
spine-↑∧⁺ {L1 = ._ ∷ x₁ ∷ L1} pf S InA InB (↑L-cons pf₁ N) = 
  ↑L-cons pf₁ (spine-↑∧⁺ {L1 = x₁ ∷ L1} pf S InA InB N) 
spine-↑∧⁺ {L1 = ._ ∷ x₁ ∷ L1} pf S InA InB (⊃L {A₁} {B₁} V Sp) = 
  ⊃L V (spine-↑∧⁺ {L1 = B₁ ∷ x₁ ∷ L1} pf S InA InB Sp) 
spine-↑∧⁺ {L1 = ._ ∷ x₁ ∷ L1} pf S InA InB (∧⁻L₁ {A₁} {B₁} Sp) =
  ∧⁻L₁ (spine-↑∧⁺ {L1 = A₁ ∷ x₁ ∷ L1} pf S InA InB Sp) 
spine-↑∧⁺ {L1 = ._ ∷ x₁ ∷ L1} pf S InA InB (∧⁻L₂ {A₁} {B₁} Sp) =
